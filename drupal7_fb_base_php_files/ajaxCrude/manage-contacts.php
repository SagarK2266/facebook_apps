<?php
    ...
    $tblDemo->displayAs("contact_name", "contact name");
    $tblDemo->displayAs("contact_number", "contact number");
   ...
   $tblDemo->omitField("date_modified");
	...
	$tblDemo->formatFieldWithFunction('contact_name', 'makeBlue');
	$tblDemo->formatFieldWithFunction('contact_number', 'makeBold');
