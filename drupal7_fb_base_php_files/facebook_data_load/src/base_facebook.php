...
abstract class BaseFacebook
{
  ...
  //Adopted the function from: http://stackoverflow.com/questions/10111761/facebook-deprecated-offline-access-and-server-side-60-days-access-token
...
//echo $this->getUrl('graph', $path); exit;
    $result = json_decode($this->_oauthRequest(
