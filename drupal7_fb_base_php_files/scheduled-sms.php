            ...
            <div class="fieldset-wrapper">
                ...
                <div class="form-item form-type-textarea form-item-message">
       	       ...
       	       <div class="form-item form-type-textfield form-item-schedule-on">
                    <label for="edit-schedule-on">Schedule on<span class="form-required" title="This field is required.">*</span></label> <input class="form-text required" id="edit-schedule-on" maxlength="20" name="schedule-on" size="20" type="text" value="" />
                    <div class="notice">
