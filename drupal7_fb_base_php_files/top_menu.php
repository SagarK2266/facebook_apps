...
/*
	Block include code
	include_once(CUSTOM_PHP_FILES.'top_menu.php');
*/
?>
<table align="left" border="1" >
	<thead>
		<tr>
			...
			<td scope="col">
				<a class="active" href="../drupal7_fb_base_php_files/scheduled-sms.php" target="mid_div" title="Scheduled SMS">Scheduled SMS</a></td>
			<td scope="col">
